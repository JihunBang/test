...
parser.add_argument("--LR_path", type = str, default = 'C:/Users/jihun/SRGAN-PyTorch/dataset/test1_LR')
...
parser.add_argument("--GT_path", type = str, default = 'C:/Users/jihun/SRGAN-PyTorch/dataSet/test1')
